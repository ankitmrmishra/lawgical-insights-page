...
const bookCard = ({coverPhoto , title , content ,backCover }:{coverPhoto:string,title:string,content:string ,backCover:string}) => {
...
whileHover={{ scale: 1.1 }}
    whileTap={{ scale: 0.9 }}
className='bg-LightestNavy text-Green p-2 text-center w-3/4 mt-3 cursor-pointer  hover:text-White  rounded-full'>READ MORE </motion.span>
            </p>
