...
const introduction = () => {
  return (
    <div id='home' className='max-w-contentContainer mx-auto py-10 mdl:py-24 flex flex-col gap-5 lgl:gap-8 mdl:px-10 xl:px-4 sm:p-8 sm:mt-9'>
        ...
        transition={{duration:0.3 , delay:0.3}}
            ...
            className="2 font-titleFont text-White xl:text-7xl sm:text-3xl font-bold gap-4 ">
